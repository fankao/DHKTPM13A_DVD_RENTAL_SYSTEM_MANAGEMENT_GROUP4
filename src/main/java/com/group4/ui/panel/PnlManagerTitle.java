...
public class PnlManagerTitle extends JPanel {
	...
	private JButton btnThoat;
 	ListModel<TuaDe> lmdTuaDe;
	JList listTuaDe;
	
	private TuaDe tuaDe;
	private Vector<TuaDe> dsTuaDe;
	...
	public PnlManagerTitle() {
		...
		pnLeft.setBorder(new TitledBorder(null, "Ch\u1EE9c n\u0103ng", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		pnMain.add(pnLeft);
		...
		pnRight.setBorder(new TitledBorder(null, "Danh s\u00E1ch t\u1EF1a \u0111\u1EC1", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		pnMain.add(pnRight);
	...
	private void hienDanhSachTuaDe(List<TuaDe> ds) {
